                    ...
                    <h4>Birthdate</h4>
                     <div className="d-flex justify-content-between " >
                      <div className="input-group mb-3  ">
                          ...
                          <input
                              className={`form-control ${user.error_list.birth_day ? "is-invalid" : ""}`}
                              placeholder="Day"
                              name="birth_day"
                              id="birth_day"
                              type="number"
                      ...
                      <div className="input-group text mb-3  ">
                        ...
                        <input
                          className={`form-control ${user.error_list.birth_month ? "is-invalid" : ""}`}
                          placeholder="Month"
                          name="birth_month"
                          id="birth_month"
                          type="number"
                      ...
                      <div className="input-group text mb-3 ">
                        ...
                        <input
                          className={`form-control ${user.error_list.birth_year ? "is-invalid" : ""}`}
                          placeholder="Year"
                          name="birth_year"
                          id="birth_year"
                          type="number"
